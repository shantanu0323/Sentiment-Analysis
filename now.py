...
class YouTubeApi():
    ...
    def get_video_comment(self):
        ...
        args.videourl = "https://www.youtube.com/watch?v=XS6ysDFTbLU"
        args.key = "AIzaSyBidsOhg2SZRiX8Nu_4YP1Vd5h389vwdo4"
...
def main():
    ...
    if str(sys.argv[0]) == "--s":
        y.search_keyword()
    elif str(sys.argv[0]) == "--c":
        y.get_video_comment()
    elif str(sys.argv[0]) == "--sc":
        y.channel_videos()
    else:
        y.get_video_comment()
        print(
